...
| `EpicDetails` | Productontwerp | Productplanning, Kwaliteitsbewaking en frontend | metadata plus probleem, oplossing, richtingsrelaties, eventuele UX, acceptatiecriteria en behapbaarheid; read-only |
