...
Implementatiestatus: uitgevoerd op 2026-09-09 en volledig geactiveerd op 2026-09-10. De gewone
bugfix- en epicroutes, autorisatie, gesprekken, advisor, approvals, vragen, status en Testbed zijn
opgeleverd. De hotfixadapter en het roteerbare dashboardtoken zijn op productie getest en
`PF_SOFTWARE_FACTORY_HOTFIX_ENABLED` staat aan. De bestaande Software Factory-detailroute vond de
probe terug, terwijl de lijstendpoint het marker-item niet retourneerde. Daarom zijn maximaal twee
verzendpogingen per exacte requestversie toegestaan; het bekende risico is maximaal één dubbele
story na een verloren eerste response. Zie het
