...
class QualityMvpService(
    ...
    companion object {
        ...
        private const val RESULT_SCHEMA = """{"type":"object","required":["outcome","results"],"properties":{"outcome":{"const":"PUBLISH_RESULTS"},"results":{"type":"array","items":{"type":"object","required":["workItemId","outcome","checks","evidence","missingCoverage","bugs"],"properties":{"workItemId":{"type":"string"},"outcome":{"enum":["PASSED","FAILED","NEEDS_WORK","BLOCKED","NOT_SUCCESSFUL"]},"checks":{"type":"array","items":{"type":"string"}},"evidence":{"type":"object"},"blockedReason":{"type":["string","null"]},"missingCoverage":{"type":"array","items":{"type":"string"}},"bugs":{"type":"array","items":{"type":"object"}},"explanation":{"type":"string"},"signalOutcome":{"type":"string"}}}}}}"""
    }
}
