...
class ProductPlanningMvpService(
    ...
    companion object {
        ...
        private const val SELECTION_SCHEMA = """{"type":"object","required":["outcome","epicSelections"],"properties":{"outcome":{"enum":["NO_WORK","PLAN"]},"reason":{"type":"string"},"epicSelections":{"type":"array","items":{"type":"object","required":["epicId","expectedVersion"],"properties":{"epicId":{"type":"string"},"expectedVersion":{"type":"integer"}}}}}}"""
        private const val PLAN_SCHEMA = """{"type":"object","required":["outcome","stories","todoOrder"],"properties":{"outcome":{"const":"PUBLISH_PLAN"},"stories":{"type":"array","items":{"type":"object","required":["draftKey","type","epicId","epicVersion","title","summary","content","acceptanceCriteria","dependencies","coveredAcceptanceCriteria","priorityReason"],"properties":{"draftKey":{"type":"string"},"type":{"enum":["PRODUCT_STORY","BUGFIX"]},"epicId":{"type":"string"},"epicVersion":{"type":"integer"},"bugId":{"type":["string","null"]},"bugVersion":{"type":["integer","null"]},"title":{"type":"string"},"summary":{"type":"string"},"content":{"type":"string"},"acceptanceCriteria":{"type":"array","items":{"type":"string"}},"uxDesign":{"type":["string","null"]},"dependencies":{"type":"array","items":{"type":"string"}},"coveredAcceptanceCriteria":{"type":"array","items":{"type":"string"}},"priorityReason":{"type":"string"}}}},"todoOrder":{"type":"array","items":{"type":"string"}},"stakeholderQuestion":{"type":["object","null"]},"memoryChanges":{"type":"array"}}}"""
    }
}
