...
class ModulithArchitectureTest {
    ...
    @Test fun `every business module is explicit and fail closed`() {
        ...
        val modules = listOf("product", "iteration", "research", "opportunity", "ux", "decision", "story", "monitoring", "humanaction", "agentruntime", "knowledge", "workspace", "dashboard", "config", "support", "web", "preview", "meeting", "roadmap")
