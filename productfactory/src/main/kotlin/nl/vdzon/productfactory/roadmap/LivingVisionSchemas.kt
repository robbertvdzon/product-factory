...
internal object LivingVisionSchemas {
    ...
    private val source = """{"type":"object","additionalProperties":false,"required":["url","title","accessedAt","observation","interpretation","relevance","limitations","confidence"],"properties":{"url":{"type":"string","format":"uri","maxLength":2000},"title":{"type":"string","minLength":1,"maxLength":500},"accessedAt":{"type":"string","format":"date-time"},"observation":{"type":"string","minLength":1,"maxLength":5000},"interpretation":{"type":"string","minLength":1,"maxLength":5000},"relevance":{"type":"string","minLength":1,"maxLength":5000},"limitations":{"type":"string","maxLength":3000},"confidence":{"type":"integer","minimum":0,"maximum":100},"rightsNote":{"type":"string","maxLength":2000}}}"""
    private val idea = """{"type":"object","additionalProperties":false,"required":["action","ideaKey","promise","primaryAudience","need","reason","evidence"],"properties":{"action":{"type":"string","enum":["CREATE","REFINE","MERGE","PARK","REJECT","NO_CHANGE"]},"ideaKey":{"type":"string","pattern":"^[a-z0-9]+(-[a-z0-9]+)*$","maxLength":100},"promise":{"type":"string","minLength":10,"maxLength":4000},"primaryAudience":{"type":"string","minLength":2,"maxLength":2000},"need":{"type":"string","minLength":10,"maxLength":4000},"reason":{"type":"string","minLength":2,"maxLength":3000},"evidence":{"type":"string","maxLength":5000},"mergedIdeaKeys":$stringList,"selectUx":{"type":"boolean"},"researchQuestions":$stringList}}"""
