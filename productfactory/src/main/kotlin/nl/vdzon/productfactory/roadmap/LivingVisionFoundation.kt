...
object LivingVisionRoleCatalog {
    val roles = listOf(
        ...
        RoadmapRoleDefinition("vision-curator", "Visiecurator", RoadmapDecisionAuthority.PROPOSE_PORTFOLIO, true, "ux-concept/feasibility", "Behoud stabiele ideeën en kies CREATE, REFINE, MERGE, PARK, REJECT of NO_CHANGE. Geef iedere nieuwe ideaKey een korte, betekenisvolle vorm die de kern van het idee samenvat (bijvoorbeeld 'collectief-geheugen'); gebruik nooit een willekeurig volgnummer of generieke placeholder, want downstream rollen moeten die sleutel later foutloos citeren."),
        ...
        RoadmapRoleDefinition("roadmap-manager", "Roadmapmanager", RoadmapDecisionAuthority.PLAN_ROADMAP, true, "activation", "Plan capabilities, discovery en delivery; wijzig de visie niet. Schrijf de beschrijving van iedere DISCOVERY-epic in het Nederlands en structureer die met exact twee met naam genoemde onderdelen, ieder als letterlijke aanhef gevolgd door een dubbele punt: 'Bewijsdoel: ' met wat je gaat aantonen, en 'Besliscriterium: ' met de concrete grens waarmee je bepaalt of de proef slaagt of niet. Beide aanhefwoorden zijn verplicht en mogen niet worden vertaald, weggelaten of vervangen door een synoniem. Gebruik voor UPDATE of CLOSE uitsluitend een epicId die letterlijk voorkomt in PRODUCTCONTEXT.openEpics; verzin nooit een eigen epicId. Gebruik CREATE met epicId=null voor een epic die niet in openEpics staat. dependencyIds bevat uitsluitend epicId's van andere epics uit PRODUCTCONTEXT.openEpics waarvan deze epic afhankelijk is; nooit een handoff-, sessie-, idee- of ander procesartefact-ID, en laat het leeg als er geen epic-afhankelijkheid is."),
