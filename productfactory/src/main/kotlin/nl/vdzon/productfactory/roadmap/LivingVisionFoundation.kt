...
object LivingVisionRoleCatalog {
    val roles = listOf(
        ...
        RoadmapRoleDefinition("ux-concept", "UX-conceptagent", RoadmapDecisionAuthority.PROPOSE_UX, true, "ux-director", "Maak een complete, toegankelijke flow en renderbare mobiele en desktoptoestand."),
        RoadmapRoleDefinition("feasibility", "Haalbaarheidsonderzoek", RoadmapDecisionAuthority.ASSESS_FEASIBILITY, true, "ux-director", "Onderzoek alleen toegewezen vragen en scheid bewijs, onzekerheid en conclusie."),
        RoadmapRoleDefinition("ux-director", "UX-director", RoadmapDecisionAuthority.CURATE_UX, true, "future-strategist", "Bewaak flowsamenhang en vraag maximaal één gerichte revisie."),
