...
void main() {
  test('geheugenclient leest value-class ids en bewaart stakeholderactor server-side', () async {
    ...
    expect(mutation?.url.path, contains('/agent-memory/roles/PRODUCT_DESIGNER_MVP/items'));
